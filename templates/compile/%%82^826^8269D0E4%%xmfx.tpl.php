<?php /* Smarty version 2.6.25, created on 2020-05-02 20:49:44
         compiled from ffsm/xmfx.tpl */ ?>
﻿<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>姓名详批-姓名吉凶分析、八字姓名详批-鑫旺网</title>
...
<a href="/?ac=history&type=3" class="public_h_menu">历史订单</a></header>
<div class="public_banner" id="submit2">
	<img src="/statics/ffsm/jieming/1/images/top02.png" alt="姓名测试"/>
</div>
<div class="public_tab_item">
	<form class="J_ajaxForm" action="/?ac=xmfx" method="post" id="submit1" onSubmit="return checkForm();" name="login">
		<div class="public_form_wrap">
			<ul>
                                <li><img src="\statics\ffsm\jieming\1\images\form_title.46f0961.png" style="height:100%" /></li>
				<li>
				<div class="left">
					您的姓氏
				</div>
		...
		<div class="public_agreement" style="display:none">
		...
		<div class="public_btn_s J_testFixedShow">
                    <div id="submit_btn" class="btn_img">
                        <img src="\statics\ffsm\jieming\1\images\index_pop_btn.59b9c71.png"">
                    </div>
		</div>
