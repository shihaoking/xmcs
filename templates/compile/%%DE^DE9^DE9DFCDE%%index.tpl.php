<?php /* Smarty version 2.6.25, created on 2020-05-02 20:50:45
         compiled from ffsm/index.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>真人在线算命,八字测算命理咨询</title>
<meta name="keywords" content="八字在线测算,婚姻在线测算,姓名在线测算" />
<meta name="description" content="算命先生网在线测算产品包含八字在线测算,婚姻在线测算,姓名在线测算,2020年运势测算,八字合婚测算,八字终生运等十几款优秀专业的产品服务，我们竭诚为有缘人提供我们力所能及的服务，祝您以及您的家人生活幸福、事业有成、安康体健。" />
...
<h1 class="public_h_con">2020年运势大全</h1>
	...
	<div class="swiper-container swiper-container-horizontal swiper-container-wp8-horizontal">
		<div class="swiper-wrapper">
			<div class="swiper-slide">
				<a href="/?ac=ffqm"><img src="/statics/ffsm/index/images/1.jpg" class="index_img">
					<p class="img_title"></p>
				</a>
			</div>
			<div class="swiper-slide">
			...
			<div class="swiper-slide">
				<a href="/?ac=ffqm"><img src="/statics/ffsm/index/images/2.jpg" class="index_img">
					<p class="img_title"></p>
				</a>
			</div>
			<div class="swiper-slide">
...
<div class="menu">
	<ul>
		...
		<li><a  href="/?ac=jinnian"><img src="/statics/ffsm/index/images/002.jpg" alt="" class="bg2"><p>鼠年运程</p></a></li>
		<li><a href="/?ac=gsqm"><img src="/statics/ffsm/index/images/003.jpg" alt="" class="bg3"><p>公司测名</p></a></li>
		...
		<li><a href="/?ac=hmjx"><img src="/statics/ffsm/index/images/006.jpg" alt="" class="bg6"><p>号码吉凶</p></a></li>
  ...
  <div class="smjlist"> 
   <ul class="clearfix"> 
    <li> <a href="/?ac=bazijp"> <p class="ptit">八字详批</p> <p class="ptxt">神准预测</p> <p class="pimg"><img src="/statics/ffsm/index/images/0001.jpg" alt="" /></p> </a> </li> 
    <li> <a href="/?ac=aiqingyun"> <p class="ptit">算姻缘</p> <p class="ptxt">想脱单的你必看</p> <p class="pimg"><img src="/statics/ffsm/index/images/0002.jpg" alt="" /></p> </a> </li> 
...
<div class="sortlist">
  <ul class="clearfix">
    <li>
      <a href="/?ac=yinyuancs">
        <p class="pimg">
          <img src="/statics/ffsm/index/images/01.jpg" alt=""></p>
        <p class="ptxt">谁是你的命定情人？</p>
        <p class="pbot">
          <span>
    ...
    <!--<li>
      <a href="https://www.yiadc.com/m/index.php?s=/mall/index/detail/id/94.html">
        <p class="pimg">
          <img src="/statics/ffsm/index/images/02.jpg" alt=""></p>
        <p class="ptxt">心理测试-你和现在的恋人是命中注定吗？</p>
        <p class="pbot">
          <span>
    ...
    <li>
      <a href="https://www.yiadc.com/m/">
        <p class="pimg">
          <img src="/statics/ffsm/index/images/03.jpg" alt=""></p>
        <p class="ptxt">心理测试-为什么总是遇不到想要的爱情？</p>
        <p class="pbot">
          <span>
            <i class="ics"></i>79955测试</span>
          <span>
            <i class="ihp"></i>96.3%好评</span>
        </p>
      </a>
    </li>
    <li>
      <a href="https://www.yiadc.com/m/index.php?s=/mall/index/detail/id/101.html">
        <p class="pimg">
          <img src="/statics/ffsm/index/images/04.jpg" alt=""></p>
        <p class="ptxt">你的性格，适合什么样的工作？</p>
        <p class="pbot">
          <span>
    ...
    <li>
      <a href="/?ac=jinnian">
        <p class="pimg">
          <img src="/statics/ffsm/index/images/09.jpg" alt=""></p>
        <p class="ptxt">详解鼠年运程，趋吉避凶</p>
        <p class="pbot">
          <span>
