<?php /* Smarty version 2.6.25, created on 2020-05-02 20:50:01
...
<div class="public_binding">
	...
	<div class="pb_con">
            <table class="baseinfo">
                ...
                <tr>
                    <td>性别：<span class="value-text"><?php if ($this->_tpl_vars['data']['gender'] == 1): ?>男<?php else: ?>女<?php endif; ?></span></td>
...
<div class="jieming_box">
	...
	<div class="jm_yellow J_testFixedShow">
            <p>限时优惠：<span class="price">￥<?php echo $this->_tpl_vars['money']; ?>
</span></p>
