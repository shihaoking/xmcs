<?php /* Smarty version 2.6.25, created on 2020-05-02 20:48:31
         compiled from ffsm/xmfx_find.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
...
<div class="public_binding">
	...
	<div class="pb_con">
            <table class="baseinfo">
                <tbody>
                <tr>
                    <td>姓：<span class="value-text"><?php echo $this->_tpl_vars['data']['xing']; ?>
</span></td>
                    <td>名字：<span class="value-text"><?php echo $this->_tpl_vars['data']['username']; ?>
</span></td>
                </tr>
                <tr>
                    <td>性别：<span class="value-text"><?php if ($this->_tpl_vars['data']['data']['gender'] == 1): ?>男<?php else: ?>女<?php endif; ?></span></td>
                    <td>生肖：<span class="value-text"><?php echo $this->_tpl_vars['return']['user']['sx']; ?>
</span></td>
                </tr>
                <tr>
                    <td colspan="2">生日：<span class="value-text"><?php echo $this->_tpl_vars['data']['birthday']; ?>
 <?php if ($this->_tpl_vars['data']['h'] < 0): ?>时辰未知<?php else: ?><?php echo $this->_tpl_vars['data']['h']; ?>
时<?php endif; ?></span></td>
                </tr>
                <tr>
                    <td colspan="2">
...
<?php else: ?><?php endif; ?></span></span><span><?php if ($this->_tpl_vars['return']['xm_arr']['xing2']): ?><?php echo $this->_tpl_vars['return']['xm_arr']['xing2']; ?>
...
</p><p><?php echo $this->_tpl_vars['tywh']['hyhw']; ?>
</p>
			</div>
		</div>
	...
	<div class="jb_bzmp">
		<div class="jb_bzmp_bottom">
			<div class="public_con_word">
                    ...
                    <p><?php echo $this->_tpl_vars['tywh']['aqfx']; ?>
</p>
			</div>
		</div>
