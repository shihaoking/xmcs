...
<a href="?ac=user_wdxx">
<li>
<h2 class="t2 l cl-red" ><img src="/statics/user/picture/ustb.png" width="12" height="12" style="margin-right:5px;">我的二级下线</h2>
<span class="r login_yj"> &gt; </span>
</li>
</a> 
...
<span class="r login_yj"> &gt; </span>
  ...
  <div class="public_ddxx">
      <div class="public_k">
           <span class="public_des"><div class="avatar-xjdl"><img src="<{if $i.headimgurl}><{$i.headimgurl}><{else}>/statics/user/images/userlogo.png<{/if}>"></div><{$i.nickname}></span><span class="public_pyzt">下级</span>      </div>
        <div class="public_k">
...
<a href="/?ac=user_wdxx>">首页</a> <a href="/?ac=user_wdxx&page=<{$pagepre}>" >< 上一页</a> <a href="/?ac=user_wdxx&page=<{$pagenext}>">下一页 ></a> <a href="/?ac=user_wdxx&page=<{$endpage}>">末页</a></div>
