...
<a href="?ac=user_wdcs">
<li>
<h2 class="t2 l cl-red" ><img src="/statics/user/picture/ustb.png" width="12" height="12" style="margin-right:5px;">我的测算</h2>
<span class="r login_yj"> &gt; </span>
</li>
</a>
<a href="?ac=loginout">
...
<span class="r login_yj"> &gt; </span>
  ...
  <div class="public_ddxx">
      ...
      <div class="public_k">
      <span class="public_pyzt_ddxx2">下单时间：<{$i.createtime|date_format:'%Y-%m-%d %H:%M:%S'}></span>
    </div>
...
<a href="/?ac=user_wdcs>">首页</a> <a href="/?ac=user_wdcs&page=<{$pagepre}>" >< 上一页</a> <a href="/?ac=user_wdcs&page=<{$pagenext}>">下一页 ></a> <a href="/?ac=user_wdcs&page=<{$endpage}>">末页</a></div>
