...
<head>
<meta charset="UTF-8"/>
<title>八字精批、2018流年运程详解、八字测算服务-鑫旺网</title>
<meta name="keywords" content="八字精批,生辰八字,八字排盘" />
<meta name="description" content="鑫旺网为您提供八字精批在线测算，给有缘人提供八字排盘,八字精批等专业的八字在线测算服务,我们将会用心服务每一个善信有缘人,祝您及您的家人生活幸福安康。" />
...
<br />
<img style="width:96%; height:auto; margin:0 auto; display:block;" src="/statics/ffsm/bazijingpi/1/images/102.jpg" alt="测算内容对您有什么帮助"/>
<br />
	<div class="public_border_tit">
		<div class="public_bt_top">
			<span></span>
	...
	<div class="know_img">
		<img src="/statics/ffsm/bazijingpi/1/images/0_img_11.jpg" alt="测算内容对您有什么帮助"/>
	</div>
</div>
<div class="public_bg_color">
	<div class="public_border_tit">
	...
	<div class="know_img">
		<img style="width:96%; height:auto; margin:0 auto; display:block;" src="/statics/ffsm/bazijingpi/1/images/0_img_2.jpg" alt="测算后您将知道以下信息"/>
	</div>
</div>
<div class="public_bg_color">
	<div class="public_border_tit">
...
<div class="public_bg_color">
	...
	<div class="user_feedback">
		<div class="uf_top">
			<p><b>98.6%</b>的用户通过测算明确了自己的人生方向</p>
		</div>
...
<div class="public_bg_color as_form">
	<div class="input_text">
        <span class="on">昵称：</span><input type="text" name="username" placeholder="你测算时填写的姓名">
    </div>
    <div class="input_text">
        <span class="on">订单号：</span><input type="text" name="username" placeholder="你测算时填写的姓名">
    </div>
    <div class="input_text">
        <span class="on">评论内容：</span><input type="text" name="username" placeholder="你测算时填写的姓名">
    </div>
