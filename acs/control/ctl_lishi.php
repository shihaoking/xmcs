...
class ctl_lishi extends common{
    // 自动验证设置
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','day'=>'某月某日(0101)','year'=>'某年','ad'=>'公元','keyword'=>'关键字','type'=>'属性(大事记, 出生, 逝世, 节假日, 纪念日)','title'=>'标题','content'=>'内容'),
            'addTableField'=>array('id','day','year','ad','keyword','type','title','content'),
            'editTableField'=>array('id','day','year','ad','keyword','type','title','content'),
           
            'listTableField'=>array('id','day','year','ad','keyword','type','title'),
			
            'batchUpdateTableField'=>array('id','day','year','ad','keyword','type','title'),
			...
			'ad'=>array(
				'element'=>array('e_name'=>'select','datafrom'=>$this->gongyuan),
            ),
			'keyword'=>array(
				'element'=>array('e_name'=>'input','e_type'=>'text'),
            ),
        ...
        $this->table = 'tool_history_day_event';
