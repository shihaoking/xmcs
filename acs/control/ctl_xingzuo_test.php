...
class ctl_xingzuo_test extends common{
    // 自动验证设置
    ...
    protected $categorys = array( 1=>'星座详解',2=>'星座血型');
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','t'=>'标题','tid'=>'栏目','content'=>'内容','m'=>'星座日期','xz'=>'星座(1~12)','xx'=>'血型','seo_t'=>'seo标题','seo_d'=>'seo描述','seo_k'=>'seo关键词'),
            'addTableField'=>array('t','tid','content'),
            'editTableField'=>array('t','tid','content','m','xz','xx','seo_t','seo_d','seo_k'),
           
            'listTableField'=>array('t','tid','m','xx'),
			
            'batchUpdateTableField'=>array('t','tid'),
