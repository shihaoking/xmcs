...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','title'=>'标题','days'=>'日期','content'=>'内容','xingyun'=>'幸运','jiankang'=>'健康','jianyi'=>'建议','mingren'=>'名人','taluo'=>'塔罗','jingsi'=>'静夜思','youdian'=>'优点','quedian'=>'缺点'),
            'addTableField'=>array('title','days','content'),
            'editTableField'=>array('title','days','content','xingyun','jiankang','jianyi','mingren','taluo','jingsi','youdian','quedian'),
           
            'listTableField'=>array('title','days','mingren'),
        ...
        $this->table = 'tool_birtyday_password';
