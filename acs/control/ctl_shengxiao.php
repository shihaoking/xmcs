...
class ctl_shengxiao extends common{
    // 自动验证设置
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','title'=>'标题','img'=>'缩略图','tid'=>'栏目','content'=>'内容'),
            'addTableField'=>array('title','img','tid','content'),
            'editTableField'=>array('title','img','tid','content'),
           
            'listTableField'=>array('title','img','tid'),
			
            'batchUpdateTableField'=>array('title','tid','content'),
        ...
        $this->table = 'shengxiao_xingge_data';
