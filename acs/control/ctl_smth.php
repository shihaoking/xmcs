...
class ctl_smth extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
        'ri'=>array('','notempty','生肖必须！','all'),
    ...
    public function __construct()
    {
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('ri'=>'日八字','shi'=>'时八字','tf1'=>'内容1','tf2'=>'内容2'),
            'addTableField'=>array('ri','shi'),
            'editTableField'=>array('ri','shi','tf1','tf2'),
           
            'listTableField'=>array('ri','shi'),
			
            'batchUpdateTableField'=>array('ri','shi'),
