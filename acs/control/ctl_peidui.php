...
class ctl_peidui extends common{
    // 自动验证设置
    ...
    protected $categorys = array( 385=>'星座配对', 386=>'生肖配对', 388=>'血型配对', 461=>'星座血型', 462=>'属相血型', 463=>'星座属相');
   // protected $statuses = array(0=>'正常',1=>'禁用');
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','title'=>'标题','tid'=>'栏目','content'=>'内容','shorttxt'=>'描述'),
            'addTableField'=>array('title','tid','shorttxt','content','istop'),
			
            'editTableField'=>array('title','tid','shorttxt','content'),
           
            'listTableField'=>array('id','title','tid'),
			...
			'content'=>array(
                'element'=>array('e_name'=>'textarea','style'=>'width:260px;height:180px;'),
        ...
        foreach ($ids as $key => $id)
        {
            if($id && $this->_dbfield['mainKey']){
                ...
                if($result >= 0)
                {
                    ...
                    /*
                    'shengxiao_data_extend_image'=>array(
                            'mainKey'=>'id',
                            'unionKey'=>'data_id',
    ...
    public function updatestatus(){
        echo 'start<br />';
        if(db::query('update shengxiao_data set `status`="1" where `status`="99" limit 1000')){
            echo 'success!';
        }else{
            echo 'fail!';
        }
