...
class ctl_zhugeliang extends common{
    // 自动验证设置
    ...
    protected $categorys = array( 400=>'诸葛测字');
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','title'=>'标题','tid'=>'栏目','content'=>'内容'),
            'addTableField'=>array('title','tid','content'),
            'editTableField'=>array('title','tid','content'),
           
            'listTableField'=>array('title','tid','content'),
