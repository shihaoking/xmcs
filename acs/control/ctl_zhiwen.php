...
class ctl_zhiwen extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
        'zhiwen'=>array('','notempty','指纹必须！','all'),
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('zhiwen'=>'指纹','jiexi'=>'解释'),
            'addTableField'=>array('zhiwen','jiexi'),
            'editTableField'=>array('zhiwen','jiexi'),
           
            'listTableField'=>array('zhiwen','jiexi'),
			
            'batchUpdateTableField'=>array('zhiwen','jiexi'),
