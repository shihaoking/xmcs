...
class ctl_ffsm_dsyy extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
		'sorting'=>array('','notempty','排序必须','all'),
        'project'=>array('','notempty','项目必须','all'),
        'teacher'=>array('','notempty','大师名称必须','all'),
		'money'=>array('','notempty','金额必须（单位：元）','all'),
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','sorting'=>'排序','project'=>'项目','teacher'=>'大师','money'=>'金额','title'=>'标题','images'=>'图片url','centent'=>'摘要'),
            'addTableField'=>array('sorting','project','teacher','money','title','images','centent'),
			
            'editTableField'=>array('sorting','project','teacher','money','title','images','centent'),
           
            'listTableField'=>array('id','sorting','project','teacher','money','title','images','centent'),
