...
class ctl_yuerishi extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
        'siceng'=>array('','notempty','时辰必须！','all'),
    ...
    public function __construct()
    {
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('siceng'=>'时辰','mingmi'=>'内容'),
            'addTableField'=>array('siceng','mingmi'),
            'editTableField'=>array('siceng','mingmi'),
           
            'listTableField'=>array('siceng'),
			
            'batchUpdateTableField'=>array('siceng','mingmi'),
