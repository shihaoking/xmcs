...
class ctl_fxdltxzh extends common{
    ...
    protected $_submit_validate     =   array(
		'dl_txfs'=>array('','notempty','收款平台必须','all'),
        'dl_txzh'=>array('','notempty','收款账号必须','all'),
        'dl_txnc'=>array('','notempty','收款昵称必须','all'),
		'dl_jf'=>array('','notempty','提现金额必须（单位：元）','all'),
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','uid'=>'用户id','dl_txfs'=>'收款平台','dl_txzh'=>'账号','dl_txnc'=>'昵称','dl_jf'=>'提现金额','dl_sc'=>'操作状态','dl_txbz'=>'备注','dl_txtel'=>'电话','add_time'=>'添加时间'),
            'addTableField'=>array('dl_txfs','dl_txzh','dl_txnc','dl_jf'),
			
            'editTableField'=>array('dl_txfs','dl_txzh','dl_txnc','dl_jf','dl_sc','dl_txbz'),
           
            'listTableField'=>array('id','uid','dl_txfs','dl_jf','dl_txzh','dl_txnc','dl_sc','dl_txtel','dl_txbz','add_time'),
