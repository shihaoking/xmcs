...
class ctl_page extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
        't'=>array('','notempty','标题必须！','all'),
...
//        $this->cps = array('duowan'=>'多玩','juyouqu'=>'juyouqu','laifudao'=>'来福岛','3jy'=>'3jy','baozoumanhua'=>'暴走漫画','mahua'=>'mahua','youku'=>'youku','haha'=>'haha','negui'=>'乐归网','jokeji'=>'jokeji','wasu'=>'华数','zol'=>'zol', 'duzhebao'=>'读者宝');
		$sql = 'select * from `sm_class` where mid="3"';
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','t'=>'标题','tid'=>'栏目','d'=>'描述','content'=>'内容'),
            'addTableField'=>array('t','tid','d','content'),
			
            'editTableField'=>array('t','tid','d','content'),
           
            'listTableField'=>array('t','tid','d'),
			
            'batchUpdateTableField'=>array('t','tid','d'),
			...
			'd'=>array(
				'element'=>array('e_name'=>'textarea','style'=>'width:300px;height:120px;'),
            ),
			'content'=>array(
