...
class ctl_baijiaxing extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
        'xing'=>array('','notempty','姓氏一定要填写！','all'),
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('xing'=>'姓','url'=>'拼音'),
            'addTableField'=>array('xing','url'),
            'editTableField'=>array('xing','url'),
           
            'listTableField'=>array('xing','url'),
			
            'batchUpdateTableField'=>array('xing','url'),
