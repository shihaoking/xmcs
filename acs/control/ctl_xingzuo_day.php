...
class ctl_xingzuo_day extends common{
    // 自动验证设置
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','title'=>'标题','img'=>'缩略图','tid'=>'栏目','des'=>'描述','date'=>'日期','content'=>'内容','yi'=>'宜','ji'=>'忌','shorttxt'=>'对方标题','uptime'=>'采集日期'),
            'addTableField'=>array('title','img','tid','des','date'),
            'editTableField'=>array('title','img','tid','des','date','content','yi','ji','shorttxt'),
           
            'listTableField'=>array('title','img','tid','date','shorttxt'),
			
            'batchUpdateTableField'=>array('title','tid','des'),
