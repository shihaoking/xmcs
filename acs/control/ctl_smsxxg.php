...
class ctl_smsxxg extends common{
    // 自动验证设置
    ...
    public function __construct()
    {
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('sx'=>'生肖','sxgx'=>'生肖个性'),
            'addTableField'=>array('sx','sxgx'),
            'editTableField'=>array('sx','sxgx'),
           
            'listTableField'=>array('sx'),
			
            'batchUpdateTableField'=>array('sx','sxgx'),
