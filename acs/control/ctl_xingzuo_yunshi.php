...
class ctl_xingzuo_yunshi extends common{
    // 自动验证设置
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','title'=>'标题','img'=>'缩略图','tid'=>'栏目','dsc'=>'描述','more'=>'内容','time'=>'星座日期','jintian'=>'今天运势','mingtian'=>'明天运势','zhou'=>'本周运势','yue'=>'本月运势','nian'=>'年度运势','love'=>'爱情运势','uptime'=>'采集日期'),
            'addTableField'=>array('title','img','tid','dsc','more','time','jintian','mingtian','zhou','yue','nian','uptime','love'),
            'editTableField'=>array('title','img','tid','dsc','more','time','jintian','mingtian','zhou','yue','nian','uptime','love'),
           
            'listTableField'=>array('title','img','tid','time','uptime'),
			
            'batchUpdateTableField'=>array('title','tid','dsc'),
        ...
        $this->table = 'xingzuo_yunshi_data';
