...
class ctl_fengshui extends common{
    // 自动验证设置
	...
	protected $xingbie = array(0=>'女',1=>'男');

    public function __construct()
    {
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('xingbie'=>'性别','nianfen'=>'年份','chaoxiang'=>'朝向','xiangjie'=>'详解','beizhu'=>'备注'),
            'addTableField'=>array('xingbie','nianfen','chaoxiang'),
            'editTableField'=>array('xingbie','nianfen','chaoxiang','xiangjie','beizhu'),
           
            'listTableField'=>array('xingbie','nianfen','chaoxiang'),
			
            'batchUpdateTableField'=>array('xingbie','nianfen','chaoxiang'),
            'batchDeleteTableField'=>array(
                'mainKey'=>'id',
            ),
			'xingbie'=>array(
                'element'=>array('e_name'=>'select','datafrom'=>$this->xingbie),
                'search'=>'1',
            ),
             'nianfen'=>array(
