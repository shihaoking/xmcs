...
class ctl_peidui_bh extends common{
    // 自动验证设置
    ...
    //protected $categorys = array( 385=>'星座配对', 386=>'生肖配对', 388=>'血型配对', 4=>'星座血型', 5=>'属相血型', 6=>'星座属相');
   // protected $statuses = array(0=>'正常',1=>'禁用');
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','bihua'=>'笔画数(模糊查找)','intro'=>'详解'),
            'addTableField'=>array('bihua','intro'),
			
            'editTableField'=>array('bihua','intro'),
           
            'listTableField'=>array('id','bihua','intro'),
			
            'batchUpdateTableField'=>array('bihua','intro'),
