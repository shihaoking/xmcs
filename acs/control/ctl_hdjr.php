...
class ctl_hdjr extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
        //'date'=>array('','notempty','签数必须！','all'),
       // 'content'=>array('','notempty','内容必须！','all'),
        //'num'=>array('','notempty','','all'),
        'date'=>array('id','notempty','主键必须！','update'),
    );
    ...
    protected $categorys = array( 363=>'黄道吉日');
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'date',
            'allTableField'=>array('date'=>'日期','gongli'=>'公历','nongli'=>'农历','suici'=>'岁次','taishen'=>'胎神','wuxing'=>'五行','chong'=>'冲','baiji'=>'彭祖百忌','jishen'=>'吉神宜趋','yi'=>'宜','xiongshen'=>'凶神宜忌','ji'=>'忌','jieri'=>'节日','jinianri'=>'纪念日','caishen'=>'财神','xishen'=>'喜神','fushen'=>'福神'),
            'addTableField'=>array('date','gongli','nongli','suici','yi','ji'),
            'editTableField'=>array('date','gongli','nongli','suici','taishen','wuxing','chong','baiji','jishen','yi','xiongshen','ji','jieri','jinianri','caishen','xishen','fushen'),
           
            'listTableField'=>array('date','gongli','suici','yi','ji'),
			
            'batchUpdateTableField'=>array('date','gongli','suici'),
