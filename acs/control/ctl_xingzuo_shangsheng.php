...
class ctl_xingzuo_shangsheng extends common{
	...
	protected $gongyuan = array(0=>'0公元前',1=>'1公元');
    ...
    public function __construct()
    {
		...
		$sql = 'select * from `sm_class` where parentid="364"';
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','tid'=>'栏目','tezhi'=>'特质','fgmd'=>'行事盲点','xingge'=>'性格特点','title'=>'星座名称','t'=>'seo标题','k'=>'seo关键词','d'=>'seo描述','jianjie'=>'简介'),
            'addTableField'=>array('tid','title','jianjie'),
            'editTableField'=>array('tid','title','jianjie','tezhi','fgmd','xingge','t','k','d'),
            'listTableField'=>array('id','tid','title','qianzai'),
			
            'batchUpdateTableField'=>array('id','tid','title','qianzai'),
			...
			'tezhi'=>array(
                'element'=>array('e_name'=>'textarea','style'=>'width:260px;height:160px;'),
            ),
			'fgmd'=>array(
                'element'=>array('e_name'=>'textarea','style'=>'width:260px;height:160px;'),
            ),
        ...
        $this->table = 'xingzuo_shangsheng_data';
