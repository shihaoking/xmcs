...
class ctl_haoma extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
        'title'=>array('','notempty','签数必须！','all'),
    ...
    protected $categorys = array( 361=>'号码吉凶');
...
//commentCount, favoriteCount, STATUS, intdate, updatetime, addtime
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('num'=>'编号','title'=>'标题','jx'=>'吉凶','content'=>'内容'),
            'addTableField'=>array('num','title','jx','content'),
            'editTableField'=>array('num','title','jx','content'),
           
            'listTableField'=>array('num','title','jx'),
			
            'batchUpdateTableField'=>array('title','tid','jx'),
