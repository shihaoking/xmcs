<?php
$nian1=$cookies['nianling']['y'];
$yue1=$cookies['nianling']['m'];
$ri1=$cookies['nianling']['d'];
$hh1=$cookies['nianling']['h'];
...
if ($sex == 0 && $dzs == 3 ) $mzjp.="<br>"."自己肥胖，丈夫瘦";
...
//$mzjp.="<br><br><b>性格分析:</b><br>";
$xgfx=$west[$day]."<br>".$west[100 * $month + $day]."<br>";